	...
	<form action="memberjoinformPro.jsp" method="post" align="center">
		<table border="1" align="center" width="600">
			...
			<tr height="40">
				...
				placeholder="비밀번호는 영문자, 숫자, 특수문자입력 8자리 이상 15이하로 입력"/></td>
			</tr>
			<tr height="40">
			...
			<tr height="40">
				...
				placeholder="id@domain.com 입력"/></td>
			</tr>
			<tr height="40">
			...
			<tr height="40">
				...
				<td width="250">
					...
					<input type="radio" name="age" value="60대"/>70대
					<input type="radio" name="age" value="60대"/>80대
				</td>
			</tr>
			<tr height="40">
